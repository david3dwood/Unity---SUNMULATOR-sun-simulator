...
public class FlyCamera_Walk : MonoBehaviour {
     ...
     * F : Change fly or walk mode
     */
 
    public float mouseSensitivity     = 3.0f;        // Mouse rotation sensitivity.
    public float speed                = 6.0f;    // Regular speed.
    public float gravity            = 5.0f;    // Gravity force.
    public float shiftAdd            = 5.0f;    // Multiplied by how long shift is held.  Basically running.
    public float maxShift            = 20.0f;    // Maximum speed when holding shift.
